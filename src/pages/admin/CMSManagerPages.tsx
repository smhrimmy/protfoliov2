    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6 text-gray-100 font-sans pb-24">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">Manage career milestones, roles, and achievements.</p>
        </div>
      </div>
...
export const SkillsManager: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 text-gray-100 font-sans pb-24">
      <div>
        <h1 className="text-2xl font-bold text-white tracking-tight">Technical Skills & Radar</h1>
        <p className="text-xs text-gray-400 mt-1">Proficiencies, framework categorizations, and featured radar skills.</p>
      </div>
...
export const CredentialsManager: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8 text-gray-100 font-sans pb-24">
      <div>
        <h1 className="text-2xl font-bold text-white tracking-tight">Credentials & Testimonials</h1>
        <p className="text-xs text-gray-400 mt-1">Formal education, verified certifications, and client endorsements.</p>
      </div>
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6 text-gray-100 font-sans pb-24">
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1">Chronological record of saves, theme activations, and content lifecycle transitions.</p>
      </div>
...
export const ProfileSettings: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6 text-gray-100 font-sans pb-24">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Owner Profile & Settings</h1>
          <p className="text-xs text-gray-400 mt-1">Personal details, taglines, social links, and system flags.</p>
        </div>
        <button
          onClick={handleSave}
