...
export function App() {
  ...
  if (currentRoute === '/' || currentRoute === '/home') {
    ...
    const isTheme25 = activeThemeId?.includes('25') || currentManifest?.number === '25';
    ...
    return (
      <div className="relative min-h-screen w-full max-w-full overflow-x-hidden">
        ...
        {/* Sleek Minimalist Quick Theme Switcher Pill (Hidden on Theme 25 which has its own authentic HUD bottom bar) */}
        {!isTheme25 && (
